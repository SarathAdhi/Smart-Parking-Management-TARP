...
const char *ssid = "S20+";
const char *password = "sarathsury";
...
int inputPin2_1 = 14, val2_1 = 0, temp2_1 = 0; // D5 choose input pin (for Infrared sensor)
int inputPin2_2 = 12, val2_2 = 0, temp2_2 = 0; // D6 choose input pin (for Infrared sensor)
int inputPin2_3 = 13, val2_3 = 0, temp2_3 = 0; // D7 choose input pin (for Infrared sensor)
